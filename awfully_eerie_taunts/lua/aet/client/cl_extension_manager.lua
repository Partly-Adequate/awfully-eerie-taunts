...
local ic_selected = Material("vgui/aet/ic_selected")
local ic_not_selected = Material("vgui/aet/ic_not_selected")
...
function PANEL:Init()
	...
	self:SetZPos(-100)
	self:SetTitle("AET Extension Manager")
...
derma.DefineControl("aet_extension_manager", "", PANEL, "DFrame")
