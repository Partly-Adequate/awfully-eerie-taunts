...
surface.CreateFont("TAUNT_CountdownFont", {
	font = "Trebuchet MS",
	size = settings_height * 0.95
})

surface.CreateFont("TAUNT_SettingsFont", {
	font = "Trebuchet MS",
...
function PANEL:InitCountDown(parent, pos_x, pos_y, width, height)
	...
	lbl_countdown:SetFont("TAUNT_CountdownFont")
...
function PANEL:InitSearchArea(parent, pos_x, pos_y, width, height)
	...
	txt_search:SetFont("TAUNT_SettingsFont")
...
function PANEL:InitSortBox(parent, pos_x, pos_y, width, height)
	...
	cb_sort_by:SetFont("TAUNT_SettingsFont")
...
function PANEL:InitTauntButtons(taunt_button_width)
	...
	for k, tauntinfo in pairs(TAUNT.taunts) do
		...
		taunt_button.DoClick = function()
			TAUNT.Taunt(taunt_button.taunt)
		end
